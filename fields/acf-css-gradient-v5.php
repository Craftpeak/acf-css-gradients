...
if( !class_exists('acf_field_css_gradient') ) :


    class acf_field_css_gradient extends acf_field {
        ...
        */
        ...
        function __construct( $settings ) {
            ...
            */
            ...
            $this->label = __('CSS Gradient', 'acf-css-gradient');
            ...
            */
            ...
            $this->l10n = array(
                'error'	=> __('Error!', 'acf-css-gradient'),
            );
        ...
        function render_field_settings( $field ) {
            ...
            *  Please note that you must also have a matching $defaults value for the field name (font_size)
            ...
            acf_render_field_setting( $field, array(
                'label'			=> __('Css Gradient','acf-css-gradient'),
                'instructions'	=> __('Build Custom Gradients','acf-css-gradient'),
                'type'			=> 'number',
                'name'			=> 'font_size',
                'prepend'		=> 'px',
            ));
...
//            echo '</pre>';
            ...
            include ( 'views/admin-css-gradient-picker.php' );
        }
...
// initialize
    new acf_field_css_gradient( $this->settings );
